...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">AEKI <span class=" badge tittle-pages-logo">Shop</span></p>
            </div>
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  <a href="index.php" class="table-cell-td"><i class="fa fa-home"></i> Inicio</a>
                  <a href="product.php" class="table-cell-td"><i class="fa fa-cubes"></i> Productos</a>
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          echo ' 
                              <a href="carrito.php" class="table-cell-td"><i class="fa fa-shopping-cart"></i> Carrito</a>
                              <a href="configAdmin.php" class="table-cell-td"><i class="fa fa-cog"></i> Administración</a>
                          ...
                          echo ' 
                              ...
                              <a href="pedido.php" class="table-cell-td"><i class="fa fa-truck<<<<<"></i> Pedido</a>
                              <a href="carrito.php" class="table-cell-td"><i class="fa fa-shopping-cart"></i> Carrito</a>
                              <a href="#!" class="table-cell-td exit-system">
                          ...
                          <a href="registration.php" class="table-cell-td"><i class="fa fa-user-plus"></i> Registro</a>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">The Golden</h3>
