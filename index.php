    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/salas/sala_1_slider.jpg" alt="slider1">
                <div class="carousel-caption">
                    Bajos Precios
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/salas/sala_2_slider.jpg" alt="slider2">
                <div class="carousel-caption">
                    Estilo Inigualable
                </div>
            </div>
            <div class="item">
                 <img src="./assets/img/salas/sala_3_slider.jpg" alt="slider3">
                <div class="carousel-caption">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate en AEKI <span class="badge">Shop</span></h3>
                ...
                <div class="col-xs-12 col-sm-6">
                    <img src="./assets/img/logos/Aeki.png" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
